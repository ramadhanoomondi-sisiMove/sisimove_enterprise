-- CreateEnum
CREATE TYPE "FinancialAccountType" AS ENUM ('INDIVIDUAL', 'PLATFORM');

-- CreateEnum
CREATE TYPE "FinancialAccountPurpose" AS ENUM ('USER_WALLET', 'CUSTOMER_FUNDS', 'JOURNEY_SETTLEMENT', 'PLATFORM_REVENUE', 'PLATFORM_OPERATING', 'EXTERNAL_CLEARING');

-- CreateEnum
CREATE TYPE "FinancialAccountStatus" AS ENUM ('ACTIVE', 'SUSPENDED', 'CLOSED');

-- CreateEnum
CREATE TYPE "FinancialEntryDirection" AS ENUM ('CREDIT', 'DEBIT');

-- CreateEnum
CREATE TYPE "FinancialBalanceBucket" AS ENUM ('AVAILABLE', 'PENDING');

-- CreateEnum
CREATE TYPE "FinancialTransactionType" AS ENUM ('MONEY_IN', 'BOOKING_PAYMENT', 'JOURNEY_SETTLEMENT', 'BOOKING_FEE', 'JOURNEY_COMMISSION', 'REFUND', 'MONEY_OUT', 'ADJUSTMENT');

-- CreateEnum
CREATE TYPE "FinancialTransactionStatus" AS ENUM ('PENDING', 'COMPLETED', 'FAILED', 'REVERSED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "FinancialMoneyInMethod" AS ENUM ('MPESA', 'BANK', 'CARD', 'OTHER');

-- CreateEnum
CREATE TYPE "FinancialMoneyInStatus" AS ENUM ('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "FinancialMoneyOutMethod" AS ENUM ('MPESA', 'BANK');

-- CreateEnum
CREATE TYPE "FinancialMoneyOutStatus" AS ENUM ('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "JourneyTripCompletionConfirmationRole" AS ENUM ('PROVIDER', 'PASSENGER');

-- CreateEnum
CREATE TYPE "JourneyTripCompletionConfirmationStatus" AS ENUM ('CONFIRMED', 'WITHDRAWN');

-- CreateEnum
CREATE TYPE "JourneyTripCompletionDisputeStatus" AS ENUM ('OPEN', 'UNDER_REVIEW', 'RESOLVED', 'REJECTED', 'WITHDRAWN');

-- CreateEnum
CREATE TYPE "JourneyTripCompletionDisputeReason" AS ENUM ('TRIP_NOT_COMPLETED', 'PASSENGER_DID_NOT_TRAVEL', 'PROVIDER_DID_NOT_TRAVEL', 'WRONG_DESTINATION', 'EARLY_TERMINATION', 'SAFETY_ISSUE', 'OTHER');

-- CreateEnum
CREATE TYPE "JourneySettlementStatus" AS ENUM ('PENDING', 'SUBMITTED', 'PROCESSING', 'COMPLETED', 'FAILED', 'HELD', 'CANCELLED');

-- CreateEnum
CREATE TYPE "JourneyTripCompletionStatus" AS ENUM ('PENDING', 'CONFIRMATION_REQUIRED', 'CONFIRMED', 'DISPUTED', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "JourneyStatus" AS ENUM ('DRAFT', 'PUBLISHED', 'FULL', 'IN_PROGRESS', 'COMPLETION_PENDING', 'COMPLETED', 'CANCELLED', 'EXPIRED');
...
-- CreateTable
CREATE TABLE "journey_trip_completions" (
    "id" TEXT NOT NULL,
    "publicId" TEXT NOT NULL,
    "journeyPublicId" TEXT NOT NULL,
    "providerPublicId" TEXT NOT NULL,
    "status" "JourneyTripCompletionStatus" NOT NULL DEFAULT 'PENDING',
    "completionRequestedAt" TIMESTAMP(3),
    "confirmedAt" TIMESTAMP(3),
    ...
    CONSTRAINT "journey_trip_completions_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "journey_trip_completion_confirmations" (
    "id" TEXT NOT NULL,
    "publicId" TEXT NOT NULL,
    "completionId" TEXT NOT NULL,
    "memberPublicId" TEXT NOT NULL,
    "bookingPublicId" TEXT,
    "role" "JourneyTripCompletionConfirmationRole" NOT NULL,
    "status" "JourneyTripCompletionConfirmationStatus" NOT NULL DEFAULT 'CONFIRMED',
    "confirmedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "withdrawnAt" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "journey_trip_completion_confirmations_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "journey_trip_completion_disputes" (
    "id" TEXT NOT NULL,
    "publicId" TEXT NOT NULL,
    "completionId" TEXT NOT NULL,
    "raisedByPublicId" TEXT NOT NULL,
    "reason" "JourneyTripCompletionDisputeReason" NOT NULL,
    "description" TEXT,
    "status" "JourneyTripCompletionDisputeStatus" NOT NULL DEFAULT 'OPEN',
    ...
    CONSTRAINT "journey_trip_completion_disputes_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "MessagingConversationParticipant" (
    ...
    CONSTRAINT "MessagingConversationParticipant_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "SupportCaseParticipant" (
    "id" TEXT NOT NULL,
    "publicId" TEXT NOT NULL,
    ...
    CONSTRAINT "SupportCaseParticipant_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "SupportCaseEvidence" (
    "id" TEXT NOT NULL,
    "publicId" TEXT NOT NULL,
    "caseId" TEXT NOT NULL,
    ...
    CONSTRAINT "SupportCaseEvidence_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "SupportCaseResolution" (
    "id" TEXT NOT NULL,
    "publicId" TEXT NOT NULL,
    "caseId" TEXT NOT NULL,
    ...
    CONSTRAINT "SupportCaseResolution_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "FinancialAccount" (
    ...
    "purpose" "FinancialAccountPurpose" NOT NULL,
    "ownerPublicId" TEXT,
    "currency" TEXT NOT NULL DEFAULT 'KES',
...
CREATE TABLE "FinancialAccountEntry" (
    ...
    "balanceBucket" "FinancialBalanceBucket" NOT NULL,
    "amount" INTEGER NOT NULL,
    "currency" TEXT NOT NULL DEFAULT 'KES',
...
-- CreateTable
CREATE TABLE "FinancialMoneyIn" (
    "id" TEXT NOT NULL,
    "publicId" TEXT NOT NULL,
    "accountId" TEXT NOT NULL,
    "transactionId" TEXT NOT NULL,
    "method" "FinancialMoneyInMethod" NOT NULL,
    "amount" INTEGER NOT NULL,
    "currency" TEXT NOT NULL DEFAULT 'KES',
    "externalReference" TEXT,
    "status" "FinancialMoneyInStatus" NOT NULL DEFAULT 'PENDING',
    ...
    CONSTRAINT "FinancialMoneyIn_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "FinancialMoneyOut" (
    "id" TEXT NOT NULL,
    "publicId" TEXT NOT NULL,
    "accountId" TEXT NOT NULL,
    "transactionId" TEXT NOT NULL,
    "method" "FinancialMoneyOutMethod" NOT NULL,
    "destinationPublicId" TEXT NOT NULL,
    "amount" INTEGER NOT NULL,
    "feeAmount" INTEGER NOT NULL DEFAULT 0,
    "netAmount" INTEGER NOT NULL,
    "currency" TEXT NOT NULL DEFAULT 'KES',
    "externalReference" TEXT,
    "status" "FinancialMoneyOutStatus" NOT NULL DEFAULT 'PENDING',
    ...
    CONSTRAINT "FinancialMoneyOut_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "FinancialPricingConfiguration" (
    "id" TEXT NOT NULL,
    "publicId" TEXT NOT NULL,
    "bookingFeeAmount" INTEGER NOT NULL,
    "journeyCommissionRate" DECIMAL(5,4) NOT NULL,
    "currency" TEXT NOT NULL DEFAULT 'KES',
    "active" BOOLEAN NOT NULL DEFAULT true,
    ...
    CONSTRAINT "FinancialPricingConfiguration_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "identities_financialAccountId_key" ON "identities"("financialAccountId");
...
-- CreateIndex
CREATE UNIQUE INDEX "journey_trip_completions_publicId_key" ON "journey_trip_completions"("publicId");

-- CreateIndex
CREATE UNIQUE INDEX "journey_trip_completions_journeyPublicId_key" ON "journey_trip_completions"("journeyPublicId");

-- CreateIndex
CREATE INDEX "journey_trip_completions_providerPublicId_idx" ON "journey_trip_completions"("providerPublicId");

-- CreateIndex
CREATE INDEX "journey_trip_completions_status_idx" ON "journey_trip_completions"("status");

-- CreateIndex
CREATE INDEX "journey_trip_completions_status_createdAt_idx" ON "journey_trip_completions"("status", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "journey_trip_completion_confirmations_publicId_key" ON "journey_trip_completion_confirmations"("publicId");

-- CreateIndex
CREATE INDEX "journey_trip_completion_confirmations_completionId_idx" ON "journey_trip_completion_confirmations"("completionId");

-- CreateIndex
CREATE INDEX "journey_trip_completion_confirmations_memberPublicId_idx" ON "journey_trip_completion_confirmations"("memberPublicId");

-- CreateIndex
CREATE INDEX "journey_trip_completion_confirmations_bookingPublicId_idx" ON "journey_trip_completion_confirmations"("bookingPublicId");

-- CreateIndex
CREATE INDEX "journey_trip_completion_confirmations_completionId_role_idx" ON "journey_trip_completion_confirmations"("completionId", "role");

-- CreateIndex
CREATE INDEX "journey_trip_completion_confirmations_completionId_status_idx" ON "journey_trip_completion_confirmations"("completionId", "status");

-- CreateIndex
CREATE UNIQUE INDEX "journey_trip_completion_confirmations_completionId_memberPu_key" ON "journey_trip_completion_confirmations"("completionId", "memberPublicId");

-- CreateIndex
CREATE UNIQUE INDEX "journey_trip_completion_disputes_publicId_key" ON "journey_trip_completion_disputes"("publicId");

-- CreateIndex
CREATE INDEX "journey_trip_completion_disputes_completionId_idx" ON "journey_trip_completion_disputes"("completionId");

-- CreateIndex
CREATE INDEX "journey_trip_completion_disputes_raisedByPublicId_idx" ON "journey_trip_completion_disputes"("raisedByPublicId");

-- CreateIndex
CREATE INDEX "journey_trip_completion_disputes_status_idx" ON "journey_trip_completion_disputes"("status");

-- CreateIndex
CREATE INDEX "journey_trip_completion_disputes_reason_idx" ON "journey_trip_completion_disputes"("reason");

-- CreateIndex
CREATE INDEX "journey_trip_completion_disputes_completionId_status_idx" ON "journey_trip_completion_disputes"("completionId", "status");

-- CreateIndex
CREATE INDEX "journey_trip_completion_disputes_status_createdAt_idx" ON "journey_trip_completion_disputes"("status", "createdAt");
...
-- CreateIndex
CREATE UNIQUE INDEX "MessagingConversation_publicId_key" ON "MessagingConversation"("publicId");

-- CreateIndex
CREATE INDEX "MessagingConversation_journeyPublicId_idx" ON "MessagingConversation"("journeyPublicId");

-- CreateIndex
CREATE INDEX "MessagingConversation_bookingPublicId_idx" ON "MessagingConversation"("bookingPublicId");

-- CreateIndex
CREATE INDEX "MessagingConversation_status_idx" ON "MessagingConversation"("status");

-- CreateIndex
CREATE INDEX "MessagingConversation_journeyPublicId_status_idx" ON "MessagingConversation"("journeyPublicId", "status");

-- CreateIndex
CREATE UNIQUE INDEX "MessagingConversationParticipant_publicId_key" ON "MessagingConversationParticipant"("publicId");

-- CreateIndex
CREATE INDEX "MessagingConversationParticipant_conversationId_idx" ON "MessagingConversationParticipant"("conversationId");

-- CreateIndex
CREATE INDEX "MessagingConversationParticipant_memberPublicId_idx" ON "MessagingConversationParticipant"("memberPublicId");

-- CreateIndex
CREATE INDEX "MessagingConversationParticipant_memberPublicId_status_idx" ON "MessagingConversationParticipant"("memberPublicId", "status");

-- CreateIndex
CREATE INDEX "MessagingConversationParticipant_conversationId_status_idx" ON "MessagingConversationParticipant"("conversationId", "status");

-- CreateIndex
CREATE UNIQUE INDEX "MessagingConversationParticipant_conversationId_memberPubli_key" ON "MessagingConversationParticipant"("conversationId", "memberPublicId");

-- CreateIndex
CREATE UNIQUE INDEX "MessagingMessage_publicId_key" ON "MessagingMessage"("publicId");

-- CreateIndex
CREATE INDEX "MessagingMessage_conversationId_idx" ON "MessagingMessage"("conversationId");

-- CreateIndex
CREATE INDEX "MessagingMessage_senderPublicId_idx" ON "MessagingMessage"("senderPublicId");
...
-- CreateIndex
CREATE INDEX "Notification_recipientPublicId_idx" ON "Notification"("recipientPublicId");

-- CreateIndex
CREATE INDEX "Notification_recipientPublicId_status_idx" ON "Notification"("recipientPublicId", "status");

-- CreateIndex
CREATE INDEX "Notification_recipientPublicId_createdAt_idx" ON "Notification"("recipientPublicId", "createdAt");
...
-- CreateIndex
CREATE INDEX "Notification_eventType_eventPublicId_idx" ON "Notification"("eventType", "eventPublicId");

-- CreateIndex
CREATE UNIQUE INDEX "NotificationPreference_publicId_key" ON "NotificationPreference"("publicId");

-- CreateIndex
CREATE UNIQUE INDEX "NotificationPreference_memberPublicId_key" ON "NotificationPreference"("memberPublicId");

-- CreateIndex
CREATE INDEX "NotificationPreference_memberPublicId_idx" ON "NotificationPreference"("memberPublicId");

-- CreateIndex
CREATE UNIQUE INDEX "NotificationDelivery_publicId_key" ON "NotificationDelivery"("publicId");
...
-- CreateIndex
CREATE INDEX "SupportCase_requesterPublicId_idx" ON "SupportCase"("requesterPublicId");
...
-- CreateIndex
CREATE INDEX "SupportCase_assignedToPublicId_idx" ON "SupportCase"("assignedToPublicId");

-- CreateIndex
CREATE INDEX "SupportCase_referenceType_referencePublicId_idx" ON "SupportCase"("referenceType", "referencePublicId");
...
-- CreateIndex
CREATE UNIQUE INDEX "SupportCaseParticipant_publicId_key" ON "SupportCaseParticipant"("publicId");

-- CreateIndex
CREATE INDEX "SupportCaseParticipant_caseId_idx" ON "SupportCaseParticipant"("caseId");

-- CreateIndex
CREATE INDEX "SupportCaseParticipant_memberPublicId_idx" ON "SupportCaseParticipant"("memberPublicId");

-- CreateIndex
CREATE INDEX "SupportCaseParticipant_caseId_role_idx" ON "SupportCaseParticipant"("caseId", "role");

-- CreateIndex
CREATE UNIQUE INDEX "SupportCaseParticipant_caseId_memberPublicId_role_key" ON "SupportCaseParticipant"("caseId", "memberPublicId", "role");

-- CreateIndex
CREATE UNIQUE INDEX "SupportCaseMessage_publicId_key" ON "SupportCaseMessage"("publicId");

-- CreateIndex
CREATE INDEX "SupportCaseMessage_caseId_idx" ON "SupportCaseMessage"("caseId");

-- CreateIndex
CREATE INDEX "SupportCaseMessage_senderPublicId_idx" ON "SupportCaseMessage"("senderPublicId");

-- CreateIndex
CREATE INDEX "SupportCaseMessage_caseId_sentAt_idx" ON "SupportCaseMessage"("caseId", "sentAt");

-- CreateIndex
CREATE UNIQUE INDEX "SupportCaseNote_publicId_key" ON "SupportCaseNote"("publicId");

-- CreateIndex
CREATE INDEX "SupportCaseNote_caseId_idx" ON "SupportCaseNote"("caseId");

-- CreateIndex
CREATE INDEX "SupportCaseNote_authorPublicId_idx" ON "SupportCaseNote"("authorPublicId");

-- CreateIndex
CREATE INDEX "SupportCaseNote_caseId_createdAt_idx" ON "SupportCaseNote"("caseId", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "SupportCaseEvidence_publicId_key" ON "SupportCaseEvidence"("publicId");

-- CreateIndex
CREATE INDEX "SupportCaseEvidence_caseId_idx" ON "SupportCaseEvidence"("caseId");

-- CreateIndex
CREATE INDEX "SupportCaseEvidence_submittedByPublicId_idx" ON "SupportCaseEvidence"("submittedByPublicId");

-- CreateIndex
CREATE INDEX "SupportCaseEvidence_assetId_idx" ON "SupportCaseEvidence"("assetId");

-- CreateIndex
CREATE UNIQUE INDEX "SupportCaseResolution_publicId_key" ON "SupportCaseResolution"("publicId");

-- CreateIndex
CREATE UNIQUE INDEX "SupportCaseResolution_caseId_key" ON "SupportCaseResolution"("caseId");

-- CreateIndex
CREATE UNIQUE INDEX "FinancialAccount_publicId_key" ON "FinancialAccount"("publicId");

-- CreateIndex
CREATE INDEX "FinancialAccount_ownerPublicId_idx" ON "FinancialAccount"("ownerPublicId");

-- CreateIndex
CREATE INDEX "FinancialAccount_type_idx" ON "FinancialAccount"("type");

-- CreateIndex
CREATE INDEX "FinancialAccount_purpose_idx" ON "FinancialAccount"("purpose");

-- CreateIndex
CREATE INDEX "FinancialAccount_status_idx" ON "FinancialAccount"("status");

-- CreateIndex
CREATE INDEX "FinancialAccount_ownerPublicId_purpose_idx" ON "FinancialAccount"("ownerPublicId", "purpose");

-- CreateIndex
CREATE UNIQUE INDEX "FinancialAccountEntry_publicId_key" ON "FinancialAccountEntry"("publicId");

-- CreateIndex
CREATE INDEX "FinancialAccountEntry_accountId_idx" ON "FinancialAccountEntry"("accountId");

-- CreateIndex
CREATE INDEX "FinancialAccountEntry_transactionId_idx" ON "FinancialAccountEntry"("transactionId");

-- CreateIndex
CREATE INDEX "FinancialAccountEntry_accountId_createdAt_idx" ON "FinancialAccountEntry"("accountId", "createdAt");

-- CreateIndex
CREATE INDEX "FinancialAccountEntry_accountId_balanceBucket_createdAt_idx" ON "FinancialAccountEntry"("accountId", "balanceBucket", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "FinancialTransaction_publicId_key" ON "FinancialTransaction"("publicId");
...
-- CreateIndex
CREATE INDEX "FinancialTransaction_referenceType_referencePublicId_idx" ON "FinancialTransaction"("referenceType", "referencePublicId");
...
-- CreateIndex
CREATE UNIQUE INDEX "FinancialWallet_publicId_key" ON "FinancialWallet"("publicId");

-- CreateIndex
CREATE UNIQUE INDEX "FinancialWallet_accountId_key" ON "FinancialWallet"("accountId");

-- CreateIndex
CREATE UNIQUE INDEX "FinancialMoneyIn_publicId_key" ON "FinancialMoneyIn"("publicId");

-- CreateIndex
CREATE UNIQUE INDEX "FinancialMoneyIn_transactionId_key" ON "FinancialMoneyIn"("transactionId");

-- CreateIndex
CREATE INDEX "FinancialMoneyIn_accountId_idx" ON "FinancialMoneyIn"("accountId");

-- CreateIndex
CREATE INDEX "FinancialMoneyIn_status_idx" ON "FinancialMoneyIn"("status");

-- CreateIndex
CREATE INDEX "FinancialMoneyIn_externalReference_idx" ON "FinancialMoneyIn"("externalReference");

-- CreateIndex
CREATE INDEX "FinancialMoneyIn_initiatedAt_idx" ON "FinancialMoneyIn"("initiatedAt");

-- CreateIndex
CREATE UNIQUE INDEX "FinancialMoneyOut_publicId_key" ON "FinancialMoneyOut"("publicId");

-- CreateIndex
CREATE UNIQUE INDEX "FinancialMoneyOut_transactionId_key" ON "FinancialMoneyOut"("transactionId");

-- CreateIndex
CREATE INDEX "FinancialMoneyOut_accountId_idx" ON "FinancialMoneyOut"("accountId");

-- CreateIndex
CREATE INDEX "FinancialMoneyOut_status_idx" ON "FinancialMoneyOut"("status");

-- CreateIndex
CREATE INDEX "FinancialMoneyOut_destinationPublicId_idx" ON "FinancialMoneyOut"("destinationPublicId");

-- CreateIndex
CREATE INDEX "FinancialMoneyOut_externalReference_idx" ON "FinancialMoneyOut"("externalReference");

-- CreateIndex
CREATE INDEX "FinancialMoneyOut_requestedAt_idx" ON "FinancialMoneyOut"("requestedAt");

-- CreateIndex
CREATE UNIQUE INDEX "FinancialPricingConfiguration_publicId_key" ON "FinancialPricingConfiguration"("publicId");

-- CreateIndex
CREATE INDEX "FinancialPricingConfiguration_active_idx" ON "FinancialPricingConfiguration"("active");

-- CreateIndex
CREATE INDEX "FinancialPricingConfiguration_effectiveFrom_idx" ON "FinancialPricingConfiguration"("effectiveFrom");

-- CreateIndex
CREATE INDEX "FinancialPricingConfiguration_effectiveTo_idx" ON "FinancialPricingConfiguration"("effectiveTo");

-- AddForeignKey
ALTER TABLE "identities" ADD CONSTRAINT "identities_financialAccountId_fkey" FOREIGN KEY ("financialAccountId") REFERENCES "FinancialAccount"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "journey_trip_completion_confirmations" ADD CONSTRAINT "journey_trip_completion_confirmations_completionId_fkey" FOREIGN KEY ("completionId") REFERENCES "journey_trip_completions"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "journey_trip_completion_disputes" ADD CONSTRAINT "journey_trip_completion_disputes_completionId_fkey" FOREIGN KEY ("completionId") REFERENCES "journey_trip_completions"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "journey_settlements" ADD CONSTRAINT "journey_settlements_completionId_fkey" FOREIGN KEY ("completionId") REFERENCES "journey_trip_completions"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MessagingConversationParticipant" ADD CONSTRAINT "MessagingConversationParticipant_conversationId_fkey" FOREIGN KEY ("conversationId") REFERENCES "MessagingConversation"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SupportCaseParticipant" ADD CONSTRAINT "SupportCaseParticipant_caseId_fkey" FOREIGN KEY ("caseId") REFERENCES "SupportCase"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SupportCaseEvidence" ADD CONSTRAINT "SupportCaseEvidence_caseId_fkey" FOREIGN KEY ("caseId") REFERENCES "SupportCase"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SupportCaseResolution" ADD CONSTRAINT "SupportCaseResolution_caseId_fkey" FOREIGN KEY ("caseId") REFERENCES "SupportCase"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "FinancialAccountEntry" ADD CONSTRAINT "FinancialAccountEntry_transactionId_fkey" FOREIGN KEY ("transactionId") REFERENCES "FinancialTransaction"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FinancialWallet" ADD CONSTRAINT "FinancialWallet_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "FinancialAccount"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FinancialMoneyIn" ADD CONSTRAINT "FinancialMoneyIn_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "FinancialAccount"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FinancialMoneyIn" ADD CONSTRAINT "FinancialMoneyIn_transactionId_fkey" FOREIGN KEY ("transactionId") REFERENCES "FinancialTransaction"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FinancialMoneyOut" ADD CONSTRAINT "FinancialMoneyOut_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "FinancialAccount"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FinancialMoneyOut" ADD CONSTRAINT "FinancialMoneyOut_transactionId_fkey" FOREIGN KEY ("transactionId") REFERENCES "FinancialTransaction"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
