...
-- CreateEnum
CREATE TYPE "CommercialChargeType" AS ENUM ('BOOKING_FEE', 'SURCHARGE', 'ADJUSTMENT');

-- CreateEnum
CREATE TYPE "CommercialChargeStatus" AS ENUM ('PENDING', 'ASSESSED', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "FinancialDisbursementDestinationType" AS ENUM ('MOBILE_MONEY', 'BANK', 'OTHER');
...
CREATE TABLE "commercial_charges" (
    "id" TEXT NOT NULL,
    "publicId" TEXT NOT NULL,
    "type" "CommercialChargeType" NOT NULL,
    "status" "CommercialChargeStatus" NOT NULL DEFAULT 'PENDING',
    "referenceType" TEXT NOT NULL,
    "referencePublicId" TEXT NOT NULL,
    "payerPublicId" TEXT,
    "beneficiaryPublicId" TEXT,
    "amount" INTEGER NOT NULL,
    "currency" TEXT NOT NULL DEFAULT 'KES',
    ...
    CONSTRAINT "commercial_charges_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "commercial_charges_publicId_key" ON "commercial_charges"("publicId");

-- CreateIndex
CREATE INDEX "commercial_charges_referenceType_referencePublicId_idx" ON "commercial_charges"("referenceType", "referencePublicId");

-- CreateIndex
CREATE INDEX "commercial_charges_payerPublicId_idx" ON "commercial_charges"("payerPublicId");

-- CreateIndex
CREATE INDEX "commercial_charges_beneficiaryPublicId_idx" ON "commercial_charges"("beneficiaryPublicId");

-- CreateIndex
CREATE INDEX "commercial_charges_type_idx" ON "commercial_charges"("type");

-- CreateIndex
CREATE INDEX "commercial_charges_status_idx" ON "commercial_charges"("status");

-- CreateIndex
CREATE INDEX "commercial_charges_assessedAt_idx" ON "commercial_charges"("assessedAt");
...
-- CreateIndex
CREATE INDEX "financial_account_withdrawals_destinationId_idx" ON "financial_account_withdrawals"("destinationId");
...
-- AddForeignKey
ALTER TABLE "financial_account_withdrawals" ADD CONSTRAINT "financial_account_withdrawals_destinationId_fkey" FOREIGN KEY ("destinationId") REFERENCES "financial_disbursement_destinations"("id") ON DELETE SET NULL ON UPDATE CASCADE;
