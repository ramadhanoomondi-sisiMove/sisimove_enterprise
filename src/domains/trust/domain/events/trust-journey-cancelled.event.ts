// src/domains/trust/domain/events/trust-journey-cancelled.event.ts

import { TrustProfileDomainEvent } from './trust-profile-domain.event';

export class TrustJourneyCancelledEvent extends TrustProfileDomainEvent {
  constructor(
