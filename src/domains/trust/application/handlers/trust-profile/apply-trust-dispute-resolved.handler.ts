// src/domains/trust/application/handlers/trust-profile/apply-trust-dispute-resolved.handler.ts

import type { CommandHandler } from '../../../../../foundation/kernel/application/command-handler';

import type { ApplyTrustDisputeResolvedCommand } from '../../commands/trust-profile/apply-trust-dispute-resolved.command';
...
export class ApplyTrustDisputeResolvedHandler implements CommandHandler<ApplyTrustDisputeResolvedCommand> {
  constructor(private readonly repository: TrustProfileRepository) {}

  async execute(command: ApplyTrustDisputeResolvedCommand): Promise<void> {
    ...
    aggregate.applyDisputeResolved(
