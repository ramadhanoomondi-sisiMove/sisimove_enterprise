// -----------------------------------------------------------------------------
// Journey Completion — Reject Dispute Request DTO
// -----------------------------------------------------------------------------
...
/**
 * REST request DTO for rejecting a Journey Completion dispute.
 *
 ...
 * boundary before creating RejectJourneyCompletionDisputeCommand.
 */
export class RejectJourneyCompletionDisputeDto {
  // ===========================================================================
  // Resolver
  // ===========================================================================

  /**
   * Optional public identity of the member rejecting the dispute.
   *
   * When omitted, the controller may use the authenticated member identity.
   */
  @ApiPropertyOptional({
    description:
      'Optional public identifier of the member rejecting the dispute. When omitted, the authenticated member is used.',
   ...
   */
  @ApiProperty({
    description: 'Explanation for rejecting the dispute.',
    example:
      'The submitted evidence did not establish a valid completion dispute, so the claim was rejected.',
    minLength: 10,
    maxLength: 2000,
  })
  @IsString()
  ...
  @ApiProperty({
    description:
      'Correlation identifier used for tracing the dispute rejection command.',
   ...
   * a Date before constructing RejectJourneyCompletionDisputeCommand.
   *
   * When omitted, the aggregate uses the current time.
   */
  @ApiPropertyOptional({
    description: 'Optional timestamp at which the dispute was rejected.',
...
export default RejectJourneyCompletionDisputeDto;
