// -----------------------------------------------------------------------------
// Journey Completion — Withdraw Dispute Request DTO
// -----------------------------------------------------------------------------
...
/**
 * REST request DTO for withdrawing a Journey Completion dispute.
 *
 * The Journey Completion and dispute public identities are supplied through
 * the route parameters.
 *
 * `withdrawnByPublicId` may be supplied explicitly, but the controller may
 ...
 * boundary before creating WithdrawJourneyCompletionDisputeCommand.
 */
export class WithdrawJourneyCompletionDisputeDto {
  // ===========================================================================
  // Withdrawn By
  // ===========================================================================

  /**
   * Optional public identity of the member withdrawing the dispute.
   *
   * When omitted, the controller may use the authenticated member identity.
   */
  @ApiPropertyOptional({
    description:
      'Optional public identifier of the member withdrawing the dispute. When omitted, the authenticated member is used.',
  ...
  @ApiProperty({
    description:
      'Correlation identifier used for tracing the dispute withdrawal command.',
   ...
   * value into a Date before constructing the command.
   *
   * When omitted, the aggregate uses the current time.
   */
  @ApiPropertyOptional({
    description:
      'Optional timestamp at which the dispute withdrawal takes effect.',
...
export default WithdrawJourneyCompletionDisputeDto;
