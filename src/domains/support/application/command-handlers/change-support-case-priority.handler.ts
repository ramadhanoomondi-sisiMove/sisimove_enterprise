// -----------------------------------------------------------------------------
// Support — Change Support Case Priority Command Handler
// -----------------------------------------------------------------------------
...
import type { ChangeSupportCasePriorityCommand } from '../commands/change-support-case-priority.command';
...
@Injectable()
export class ChangeSupportCasePriorityHandler implements CommandHandler<
...
> {
  ...
  public async execute(
    command: ChangeSupportCasePriorityCommand,
...
export default ChangeSupportCasePriorityHandler;
