// -----------------------------------------------------------------------------
// Support — Add Support Case Note Command Handler
// -----------------------------------------------------------------------------
...
import type { AddSupportCaseNoteCommand } from '../commands/add-support-case-note.command';
...
@Injectable()
export class AddSupportCaseNoteHandler implements CommandHandler<
...
> {
  ...
  public async execute(
    command: AddSupportCaseNoteCommand,
    ...
    const note = SupportCaseNoteEntity.create({
      authorPublicId: command.authorPublicId,
      content: command.content,
    });

    aggregate.addNote(note, command.correlationId, command.causationId);
...
export default AddSupportCaseNoteHandler;
