// -----------------------------------------------------------------------------
// Support — Start Support Case Command Handler
// -----------------------------------------------------------------------------
...
import type { StartSupportCaseCommand } from '../commands/start-support-case.command';
...
@Injectable()
export class StartSupportCaseHandler implements CommandHandler<
...
> {
  ...
  public async execute(
    command: StartSupportCaseCommand,
    ...
    aggregate.start(command.correlationId, command.causationId);
...
export default StartSupportCaseHandler;
