// -----------------------------------------------------------------------------
// Support Case — Get Notes Query
// -----------------------------------------------------------------------------
//
// Application query for retrieving all internal notes belonging to a Support
// Case.
//
// Aggregate:
...
// - identify the Support Case whose notes are requested.
//
...
export class GetSupportCaseNotesQuery implements Query {
  public constructor(
    public readonly supportCasePublicId: SupportCasePublicId,
  ) {}
}

export default GetSupportCaseNotesQuery;
