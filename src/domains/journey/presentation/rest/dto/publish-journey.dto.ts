...
export class PublishJourneyDto {
  @ApiProperty({
    example: 'JRN-ABC12345',
    description: 'Public ID of the Journey to publish.',
  })
  @IsString()
  @MinLength(3)
  @MaxLength(100)
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Optional effective publication timestamp. Defaults to handler execution time.',
    format: 'date-time',
  })
  @IsOptional()
  @IsDateString()
