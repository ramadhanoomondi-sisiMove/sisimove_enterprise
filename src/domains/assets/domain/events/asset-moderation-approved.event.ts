// src/domains/assets/domain/events/asset-moderation-approved.event.ts

import type { AssetModerationType } from '../value-objects';

import { AssetDomainEvent } from './asset-domain.event';

export class AssetModerationApprovedEvent extends AssetDomainEvent {
  constructor(
    assetId: string,
    publicId: string,
