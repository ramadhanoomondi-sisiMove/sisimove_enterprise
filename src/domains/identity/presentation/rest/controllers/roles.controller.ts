...
export class RolesController {
  ...
  //     orderByDisplayOrder
  //
  // The controller only translates the DTO into GetRolesQueryFilters.
  //
  // ---------------------------------------------------------------------------
  ...
  //     description
  //
  // The controller creates the domain value objects and generates the
  ...
  // PATCH /roles/:rolePublicId/activate
  //
  // The HTTP request contains no lifecycle timestamp.
  //
  // The Role aggregate/application workflow establishes the effective
  // activation timestamp.
  //
  // Activation idempotency, lifecycle invariants, and system-role rules remain
  ...
  //
  // System-role protection remains inside the Role domain/application boundary.
  //
  // ---------------------------------------------------------------------------
