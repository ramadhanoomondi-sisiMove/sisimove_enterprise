// -----------------------------------------------------------------------------
// Verification Request — Domain Entity
// -----------------------------------------------------------------------------
//
// Domain entity representing a single verification request.
//
// Aggregate:
//
...
// Responsibilities:
//
// - represent one verification evidence request;
// - maintain the request lifecycle;
// - enforce request-level invariants;
// - maintain reviewer and review information;
// - maintain the submitted verification asset reference;
// - expose immutable/read-safe domain state;
// - protect mutable values such as Date and metadata.
//
// This entity does NOT:
//
// - approve the overall Verification aggregate;
// - change VerificationLevel;
// - mark profilePhotoVerified;
// - mark governmentIdVerified;
// - mark driverLicenseVerified;
// - access Prisma;
...
//
// The Verification aggregate owns the overall verification state.
// This entity owns only the lifecycle of the individual request.
//
// Frozen persistence mapping:
//
// VerificationRequest
// ├── id
// ├── publicId
...
export interface VerificationRequestProps {
  /**
   * Public identity of this verification request.
   */
  ...
  /**
   * Type of verification evidence being requested.
   */
  ...
  /**
   * Public identity of the submitted asset.
   */
  ...
  /**
   * Public identity of the reviewer.
   */
...
export interface CreateVerificationRequestProps {
  /**
   * Optional externally supplied public ID.
   *
   * Normally generated by the entity.
   */
  publicId?: VerificationRequestPublicId;
  ...
  /**
   * Requested verification evidence type.
   */
  type: VerificationRequestType;
...
> {
  ...
  public static create(
    ...
    const metadata =
      props.metadata !== undefined
        ? VerificationRequestEntity.cloneMetadata(props.metadata)
        : undefined;
  ...
  private static validateState(
    ...
    //
    // because the frozen persistence model does not define such an invariant.
    //
    // We do enforce lifecycle ordering:
    //
    ...
    VerificationRequestEntity.validateMetadata(metadata);
  ...
  private static validateMetadata(
    ...
    if (
      ...
      throw new VerificationRequestInvalidStatusException(
        'Verification request metadata must be a JSON object.',
      );
    }
  }
