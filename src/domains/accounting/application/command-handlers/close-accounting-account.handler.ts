// -----------------------------------------------------------------------------
// Accounting — Close Accounting Account Command Handler
// -----------------------------------------------------------------------------
...
import type { CloseAccountingAccountCommand } from '../commands/close-accounting-account.command';
...
@Injectable()
export class CloseAccountingAccountHandler implements CommandHandler<
...
> {
  ...
  public async execute(
    command: CloseAccountingAccountCommand,
    ...
    // -------------------------------------------------------------------------
    //
    // Lifecycle rules, including the terminal CLOSED state, remain inside
    // AccountingAccountAggregate / AccountingAccountEntity.
    //
    // -------------------------------------------------------------------------

    aggregate.close(command.correlationId, command.causationId);
...
export default CloseAccountingAccountHandler;
