// src/domains/social/domain/events/traveller-profile-corridor-updated.event.ts
...
export class TravellerProfileCorridorUpdatedEvent extends TravellerProfileDomainEvent {
  constructor(
    ...
    super(
      travellerProfileId,
      publicId,
      'TravellerProfileCorridorUpdated',
      correlationId,
      causationId,
    );
