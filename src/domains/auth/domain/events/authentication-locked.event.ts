// -----------------------------------------------------------------------------
// Authentication — Locked Domain Event
// -----------------------------------------------------------------------------
...
/**
 * Raised when an Authentication aggregate is locked.
 *
 * The event records the Authentication lifecycle transition to LOCKED.
 *
 * Security-sensitive authentication credentials are intentionally excluded
 * from the event payload.
 */
export class AuthenticationLockedEvent extends AuthenticationDomainEvent {
  // ---------------------------------------------------------------------------
  // Constructor
  // ---------------------------------------------------------------------------
