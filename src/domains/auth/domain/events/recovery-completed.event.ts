// -----------------------------------------------------------------------------
// Recovery — Completed Domain Event
// -----------------------------------------------------------------------------
//
// Raised when a Recovery aggregate is completed.
//
// The event records the Recovery lifecycle transition to COMPLETED together
 ...
 * Raised when a Recovery aggregate is completed.
 *
 * The event records the Recovery completion transition without exposing
 * recovery tokens, token hashes, credentials, or other security-sensitive
 * material.
 */
export class RecoveryCompletedEvent extends RecoveryDomainEvent {
  // ===========================================================================
  // Constructor
  // ===========================================================================
