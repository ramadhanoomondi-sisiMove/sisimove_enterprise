// -----------------------------------------------------------------------------
// Authentication — Disabled Domain Event
// -----------------------------------------------------------------------------
...
/**
 * Raised when an Authentication aggregate is disabled.
 *
 * The event records the Authentication lifecycle transition to DISABLED.
 *
 * Security-sensitive authentication credentials are intentionally excluded
 * from the event payload.
 */
export class AuthenticationDisabledEvent extends AuthenticationDomainEvent {
  // ---------------------------------------------------------------------------
  // Constructor
  // ---------------------------------------------------------------------------
