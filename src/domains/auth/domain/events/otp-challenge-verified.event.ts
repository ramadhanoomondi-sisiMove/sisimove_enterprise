// -----------------------------------------------------------------------------
// OTP Challenge — Verified Domain Event
// -----------------------------------------------------------------------------
//
// Raised when an OtpChallenge aggregate is successfully verified.
//
// The event records the successful verification of an OTP Challenge without
 ...
 * Raised when an OtpChallenge aggregate is successfully verified.
 *
 * The event records the successful OTP Challenge verification using only
 * security-approved, non-secret event data.
 */
export class OtpChallengeVerifiedEvent extends OtpChallengeDomainEvent {
  // ===========================================================================
  // Constructor
  // ===========================================================================
