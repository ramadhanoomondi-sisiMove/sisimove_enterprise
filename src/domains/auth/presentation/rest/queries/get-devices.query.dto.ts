// -----------------------------------------------------------------------------
// Device — Get Devices Query DTO
// -----------------------------------------------------------------------------
//
// REST query DTO for retrieving all Device aggregates belonging to an
// Identity.
//
// Query:
//
 ...
 * DeviceIdentityPublicId value object before constructing GetDevicesQuery.
 */
export class GetDevicesQueryDto {
  ...
  /**
   * Public identifier of the Identity whose Devices should be retrieved.
   *
   ...
   *
   * before constructing GetDevicesQuery.
   *
   * Example:
   *
   * - IDN-01K3R8Y7Q2
  ...
  @ApiProperty({
    ...
    description:
      'Public identifier of the Identity whose Devices should be retrieved. The transport string is converted to the DeviceIdentityPublicId value object at the application boundary.',
...
export default GetDevicesQueryDto;
