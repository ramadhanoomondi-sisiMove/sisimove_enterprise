// -----------------------------------------------------------------------------
// Commercial Booking Commission Cancelled Event
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Commercial Booking Commission Cancelled
// -----------------------------------------------------------------------------

/**
 * Raised when a Commercial Booking Commission aggregate is cancelled.
 *
 * The event contains the commission identity, commercial assessment snapshot,
 * and cancellation timestamp required by downstream consumers to identify
 * and process the cancelled commercial assessment.
 */
export class CommercialBookingCommissionCancelledEvent extends CommercialDomainEvent {
  // ---------------------------------------------------------------------------
  // Constructor
  // ---------------------------------------------------------------------------
  ...
  constructor(
    ...
    super(
      ...
      'CommercialBookingCommissionCancelled',
      correlationId,
      causationId,
      eventVersion,
      eventSchemaVersion,
  ...
  /**
   * Public identity of the cancelled Commercial Booking Commission.
   */
  ...
  /**
   * Commercial commission amount associated with this booking commission.
   */
  ...
  /**
   * Time at which the booking commission was cancelled.
   */
