// -----------------------------------------------------------------------------
// Financial Payment — Cancel Command
// -----------------------------------------------------------------------------
//
// Application command for transitioning a Financial Payment aggregate into
// the CANCELLED terminal state.
//
// The command represents the application intent to cancel a Financial Payment.
//
// Cancellation is a Financial Payment lifecycle operation. Provider-side
// cancellation, when required, is handled separately by the appropriate
...
/**
 * Command for cancelling a Financial Payment.
 *
 * The command identifies the Financial Payment aggregate that should
 * transition into CANCELLED.
 *
 * The cancellation timestamp is determined by the application/domain
 * operation and is therefore intentionally NOT supplied by the command.
 *
 * The aggregate enforces that an active Financial Payment Attempt must not
 * exist when the payment is cancelled.
 *
 ...
 * - causationId
 */
export class CancelFinancialPaymentCommand implements Command {
  // ===========================================================================
  // Constructor
  // ===========================================================================
