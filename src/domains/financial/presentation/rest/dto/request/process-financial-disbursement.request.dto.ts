// -----------------------------------------------------------------------------
// Financial Disbursement — Process Request DTO
// -----------------------------------------------------------------------------
//
// Presentation-layer request DTO for beginning processing of an existing
...
//
// - Validate the incoming transport data.
...
export class ProcessFinancialDisbursementRequestDto {
  // ===========================================================================
  // Financial Disbursement
  // ===========================================================================
  ...
  @ApiProperty({
    description:
      'Public identity of the Financial Disbursement to begin processing.',
