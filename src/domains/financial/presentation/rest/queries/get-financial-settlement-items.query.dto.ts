// -----------------------------------------------------------------------------
// Financial Settlement Items — Get Request DTO
// -----------------------------------------------------------------------------
//
// REST request DTO for retrieving the Settlement Items belonging to an
// existing Financial Settlement.
//
// The request identifies the owning Financial Settlement through its public
// identifier.
//
...
// Example:
//
//     GET /financial-settlements/FST-WQC6Y7G/items
//
// -----------------------------------------------------------------------------
...
/**
 * REST request for retrieving the Settlement Items belonging to a Financial
 * Settlement.
 *
 * Represents the transport-level identity of the owning Financial
 * Settlement.
 *
 * The application/query boundary converts the primitive
 * `settlementPublicId` into the FinancialSettlementPublicId value object
 * before constructing the GetFinancialSettlementItemsQuery.
 *
 * The DTO intentionally does not expose domain value objects.
 */
export class GetFinancialSettlementItemsRequestDto {
  // ===========================================================================
  // Financial Settlement
  // ===========================================================================

  /**
   * Public identifier of the Financial Settlement whose Items are requested.
   *
   * Example:
   *
   *     FST-WQC6Y7G
...
export {
  MIN_SETTLEMENT_PUBLIC_ID_LENGTH as FINANCIAL_SETTLEMENT_ITEMS_PUBLIC_ID_MIN_LENGTH,
  MAX_SETTLEMENT_PUBLIC_ID_LENGTH as FINANCIAL_SETTLEMENT_ITEMS_PUBLIC_ID_MAX_LENGTH,
};
...
export default GetFinancialSettlementItemsRequestDto;
