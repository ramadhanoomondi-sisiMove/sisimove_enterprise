// -----------------------------------------------------------------------------
// sisiMove — useRemoveParticipant
// -----------------------------------------------------------------------------
//
// Responsibilities:
// - Execute the participant removal operation.
...
export interface RemoveParticipantVariables {
...
/**
 * Removes a participant from Journey Boarding.
 *
